...
public class Constants {
    ...
    // Intent extras keys
    //----------------------------------------------------------------------------------------------
    public static final String INTENT_PASS_NOTES = "intent_notes";

    public static final String INTENT_PASS_NOTE_REMINDERS = "intent_notes_reminder";

    public static final String INTENT_PASS_CHECKLISTS = "intent_checklists";

    public static final String INTENT_PASS_CHECKLIST_REMINDERS = "intent_checklists_reminder";

    public static final String INTENT_PASS_NOTES_TYPE = "intent_notes_type";

    public static final String INTENT_PASS_POSITION = "intent_position";
