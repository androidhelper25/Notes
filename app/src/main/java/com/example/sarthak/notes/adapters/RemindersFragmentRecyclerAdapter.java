...
public class RemindersFragmentRecyclerAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RemindersFragmentRecyclerAdapter(Context context, ArrayList<Object> remindersList, ArrayList<String> typeOfNote) {

        mInflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);

        this.mContext = context;
        // retrieve list of 'Reminders' and type of note,i.e.,Notes or Checklists, from RemindersFragment
